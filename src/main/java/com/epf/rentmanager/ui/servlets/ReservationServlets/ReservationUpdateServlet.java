...
public class ReservationUpdateServlet extends HttpServlet {
    ...
    /**
     * Servlet for the http get request on the /rents/update endpoint
     * 
     * @param request
     * @param response
     * @throws ServletException
    ...
    public void doGet(final HttpServletRequest request, final HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("reserva", reservationService.findById(reservationId));
    ...
    /**
     * Servlet for the http post request on the /rents/update endpoint
     * 
     * @param request
     * @param response
     * @throws ServletException
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            reservationService.update(ReservationServletsUtils.requestToReservation(request, true));
